...
namespace ReportingCloud.Viewer
{
    ...
    public class PageDrawing : UserControl
    {
        ...
        override protected void OnMouseDown(MouseEventArgs mea)
        {
            ...
            {
                Viewer rv = this.Parent as Viewer;
                bool bInvoke = true;
                if (rv != null)
                {
        ...
        private void DrawString(PageText pt, Graphics g, RectangleF r)
        {
            ...
            try
            {
                ...
                else if (si.TextAlign == TextAlignEnum.JustifiedLine)
                    GraphicsExtended.DrawStringJustified(g, pt.Text, drawFont, drawBrush, r2, GraphicsExtended.JustifiedLineSeparator.Line);
                else if (si.TextAlign == TextAlignEnum.JustifiedDottedLine)
                    GraphicsExtended.DrawStringJustified(g, pt.Text, drawFont, drawBrush, r2, GraphicsExtended.JustifiedLineSeparator.DottedLine);
