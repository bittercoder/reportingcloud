...
namespace ReportingCloud.Designer
{
	...
	internal class MDIChild : Form
	{
		...
		private ReportingCloud.Designer.ReportEditPreview rdlDesigner;
		string _SourceFile;
        TabPage _Tab;               // TabPage for this MDI Child

		public MDIChild(int width, int height)
		{
			this.rdlDesigner = new ReportingCloud.Designer.ReportEditPreview();
			this.SuspendLayout();
			// 
			// rdlDesigner
			// 
			...
			rdlDesigner.OnRdlChanged += new ReportEditPreview.RdlChangeHandler(rdlDesigner_RdlChanged);
            rdlDesigner.OnHeightChanged += new DesignCtl.HeightEventHandler(rdlDesigner_HeightChanged);
            rdlDesigner.OnSelectionChanged += new ReportEditPreview.RdlChangeHandler(rdlDesigner_SelectionChanged);
			rdlDesigner.OnSelectionMoved += new ReportEditPreview.RdlChangeHandler(rdlDesigner_SelectionMoved);
			rdlDesigner.OnReportItemInserted += new ReportEditPreview.RdlChangeHandler(rdlDesigner_ReportItemInserted);
			rdlDesigner.OnDesignTabChanged += new ReportEditPreview.RdlChangeHandler(rdlDesigner_DesignTabChanged);
		...
		public ReportEditPreview Editor
		{
			get
			{
		...
		public ReportEditPreview RdlEditor
		{
			get
			{
...
/// </summary>
		...
		public ReportingCloud.Viewer.Viewer Viewer
		{
