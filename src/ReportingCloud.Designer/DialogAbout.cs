...
namespace ReportingCloud.Designer
{
	...
	public class DialogAbout : System.Windows.Forms.Form
	{
		...
		public DialogAbout()
		{
            ...
            tbLicense.Text = @"ReportingCloud Designer designs reports defined using an extension from Report Definition Language Specification.
Copyright (C) 2010  CloudSoftware

This file is part of the ReportingCloud project.
...
For additional information, email flexiblecoder@gmail.com or visit
the website http://sourceforge.net/projects/reportingcloud";
		...
		private void InitializeComponent()
		{
			...
			this.linkLabel3.Tag = "mailto:flexiblecoder@gmail.com";
            this.linkLabel3.Text = "flexiblecoder@gmail.com";
            ...
            this.linkLabel4.Tag = "http://sourceforge.net/projects/reportingcloud";
            this.linkLabel4.Text = "http://sourceforge.net/projects/reportingcloud";
			...
			this.label8.Text = "ReportingCloud Designer";
			// 
			// pictureBox2
			// 
