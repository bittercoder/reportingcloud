...
namespace ReportingCloud.Designer
{
	...
	/// </summary>
    public class ReportDesigner : System.Windows.Forms.Form, IMessageFilter
	{
		...
		private ReportingCloud.Engine.NeedPassword _GetPassword;
		private string _DataSourceReferencePassword=null;
		private bool bGotPassword=false;
		private bool bMono = DesignerUtility.IsMono();
        private readonly string DefaultHelpUrl = "http://sourceforge.net/projects/reportingcloud/forums";
        private readonly string DefaultSupportUrl = "http://sourceforge.net/projects/reportingcloud/forums";
		...
		public ReportDesigner()
		{
			...
			_GetPassword = new ReportingCloud.Engine.NeedPassword(this.GetPassword);
        ...
        void Ipc_Tick(object sender, EventArgs e)
        {
            lock (_IpcTimer)
            {
                string filename = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + ReportDesigner.IpcFileName;
  ...
  //                          Console.WriteLine(cmd);
        ...
        internal ReportingCloud.Engine.NeedPassword SharedDatasetPassword
        {
		...
		private void InitializeComponent()
		{
            ...
            // bCsv
            // 
            this.bCsv.Image = global::ReportingCloud.Designer.Properties.Resources.csv;
            ...
            this.Text = "ReportingCloud Designer";
...
//			Environment.Exit(0);
		...
		private void menuEdit_Popup(object sender, EventArgs ea)
		{
			MDIChild mc = this.ActiveMdiChild as MDIChild;
			// These menus require an MDIChild in order to work
            ReportEditPreview e = mc == null? null: mc.RdlEditor;
		...
		private void menuEditCopy_Click(object sender, System.EventArgs ea)
		{
			...
			ReportEditPreview e = mc.RdlEditor;
            if (e == null)
                return;
		...
		internal ReportEditPreview GetEditor()
		{
			MDIChild mc = this.ActiveMdiChild as MDIChild;
			if (mc == null)
				return null;
				...
				foreach(XmlNode xNodeLoop in xNode.ChildNodes)
				{
					switch (xNodeLoop.Name)
					{
                        ...
                        case "PropertiesAutoHide":
                            ...
                            break;
                        case "MapSubtypes":
                            ReportDesigner.MapSubtypes = xNodeLoop.InnerText.Split(new char[] { ',' });
                            break;
