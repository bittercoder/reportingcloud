...
{
	/// <summary>
	/// Viewer displays RDL files or syntax. 
	/// </summary>
	public class Viewer : System.Windows.Forms.Control
	{
...
<Report> 
	...
	<PageHeader>
		<Height>1 in</Height>
		<ReportItems>
			<Textbox><Top>.1in</Top><Value>ReportingCloud Software, LLC</Value><Style><FontSize>18pt</FontSize><FontWeight>Bold</FontWeight></Style></Textbox>
...
//			}
		...
		private void DrawPanelMouseWheel(object sender, MouseEventArgs e)
		{
            ...
            {
                //when we are loading a report and (int the beginning) trying a mouse wheel, it may drop with an error of invalid scroll value 
                //(the error is irregular and not clearly reproducible) this try/catch it just to fix
            }
		}
