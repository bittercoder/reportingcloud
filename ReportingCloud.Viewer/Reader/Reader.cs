...
{
	/// <summary>
	/// Reader is a application for displaying reports based on RDL.
	/// </summary>
    public class Reader : System.Windows.Forms.Form, IMessageFilter
	{
		/// <summary>
		...
		private Engine.NeedPassword _GetPassword;
		...
		private void InitializeComponent()
		{
			...
			this.Name = "RdlReader";
            this.Text = "ReportingCloud Reader";
		...
		static void Main() 
		{
			...
			Application.Run(new Reader(bMono));
		}
