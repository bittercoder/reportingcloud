...
namespace ReportingCloud.Designer
{
	...
	{
		ReportDesigner _rDesigner=null;
...
|endif|
	...
	<PageFooter>
		...
		private ReportingCloud.Viewer.Viewer rdlViewer1;
...
|endif|
	...
	<PageFooter>
		...
		public DialogDatabase(ReportDesigner rDesigner)
		{
			...
			string[] items = EngineConfig.GetProviders();
		...
		private void InitializeComponent()
		{
            ...
            this.rdlViewer1 = new ReportingCloud.Viewer.Viewer();
            ...
            this.rdlViewer1.ScrollMode = ReportingCloud.Viewer.ScrollModeEnum.Continuous;
            ...
            this.rdlViewer1.ZoomMode = ReportingCloud.Viewer.ZoomEnum.FitWidth;
            // 
            // btnCancel
            // 
