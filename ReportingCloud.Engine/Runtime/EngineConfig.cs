...
namespace ReportingCloud.Engine
{
    ...
    public class EngineConfig
    {
        ...
        static public void EngineConfigInit()
        {
            string d1, d2;
            ...
            EngineConfigInit(d1, d2);
        }

        // initialize configuration 
        static public void EngineConfigInit(params string[] dirs)
        {
            bool bLoaded = false;
            ...
            foreach (string dir in dirs)
            {
                ...
                {   // can't do much about failures; no place to report them 
                    System.Console.WriteLine("Error opening EngineConfig.xml: {0}", ex.Message);
                }
                if (bLoaded)
                    break;
            }
...
<config> 
   <DataSources> 
      ...
      <DataSource> 
         ...
         <ClassName>ReportingCloud.Data.XmlConnection</ClassName> 
      ...
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>ReportingCloud.Data.WebServiceConnection</ClassName> 
         <TableSelect></TableSelect> 
      ...
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>ReportingCloud.Data.LogConnection</ClassName> 
         <TableSelect></TableSelect> 
         <Interface>File</Interface> 
      </DataSource> 
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>ReportingCloud.Data.TxtConnection</ClassName> 
         <TableSelect></TableSelect> 
         <Interface>File</Interface> 
      </DataSource> 
      <DataSource> 
         ...
         <CodeModule>DataProviders.dll</CodeModule> 
         <ClassName>ReportingCloud.Data.FileDirConnection</ClassName> 
         <TableSelect></TableSelect> 
         <Interface>File</Interface> 
      </DataSource> 
   </DataSources> 
  ...
  <CustomReportItems> 
    <CustomReportItem> 
      ...
      <ClassName>ReportingCloud.CRI.BarCode</ClassName> 
    </CustomReportItem> 
  </CustomReportItems> 
</config>";
            }
        ...
        {
            if (SqlEntries == null)
                EngineConfigInit();      // init if necessary 
